...
/**
    ...
    /**
     * 简单加解密 江日念添加 @Title: @Description: TODO @param @param str @param @return @return 返回类型 @throws
     */
    ...
    public static boolean isEmpty(String str) {
        ...
        if (str == null || "".equals(str) || "".equals(str.trim()) || str.equals("null") || "''".equals(str.trim()))
            return true;
        return false;
    }
    ...
    public static String getYYYYString() {
        ...
        String number = "" + now.get(Calendar.YEAR) + "-" + now.getTimeInMillis();
        return number;
    }
     ...
     *
     */
    public static String ensureLengthWith0(String title, String tail, int tailLength) {
    ...
    public static final String filterHalfWord(String sourceStr) throws UnsupportedEncodingException {
    ...
    public static String getRandom18Str() {
        ...
        String random18Str = "";
        random18Str = (new Date().getTime() + "" + Math.floor(Math.random() * 100000));
    ...
    public static boolean isPhone(String str) {
        ...
        if (str.length() < 18) {
            Pattern p1 = null;
            Matcher m = null;
            p1 = Pattern.compile("^(\\(\\d{3,4}\\)|\\d{3,4}-)?\\d{7,8}(-\\d{1,4})?$"); // 验证带区号的//13
            m = p1.matcher(str);
            b = m.matches();
        }
        return b;
     ...
     * @return
     */
    public static boolean isBlankPatteern(String str) {
