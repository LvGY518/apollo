...
public class DingTalkEncryptor {
    ...
    public Map<String, String> getEncryptedMap(String plaintext, Long timeStamp, String nonce) throws DingTalkEncryptException {
        ...
        // 加密
        String encrypt = encrypt(DingDingEncryptUtils.getRandomStr(RANDOM_LENGTH), plaintext);
    ...
    private String encrypt(String random, String plaintext) throws DingTalkEncryptException {
        try {
            ...
            byte[] lengthByte = DingDingEncryptUtils.int2Bytes(plainTextBytes.length);
    ...
    private String decrypt(String text) throws DingTalkEncryptException {
        ...
        try {
            ...
            int plainTextLegth = DingDingEncryptUtils.bytes2int(networkOrder);
